...
Partial Public NotInheritable Class EquationAcc
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _EquationAcc As EquationAcc
    ...
    Friend Shared Property EquationAcc() As EquationAcc
        Get
            Return _EquationAcc
        End Get
        Set
            If (_EquationAcc Is Nothing) Then
                _EquationAcc = value
            Else
